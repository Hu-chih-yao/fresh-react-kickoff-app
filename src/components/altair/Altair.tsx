...
import { soapNoteDeclaration } from "../soap-notes/SoapNote";
...
"`
      ...
      tools: [
        ...
        { functionDeclarations: [medvisorSearchDeclaration, dailyMedApiDeclaration, soapNoteDeclaration] },
      ],
    });
  }, [setConfig]);
  ...
  // For backward compatibility - in case any visualization is requested
  useEffect(() => {
