...
export const soapNoteDeclaration: FunctionDeclaration = {
  ...
  description: "Updates the Medical Note documentation continuously in real-time as the patient consultation progresses. Use this tool frequently after every significant piece of information is shared. Update the note immediately as you learn new information about the patient's condition. This tool maintains a running medical record that the patient can download and share with healthcare providers.",
  parameters: {
    ...
    properties: {
      ...
      chiefComplaint: {
        type: SchemaType.STRING,
        description: "The main reason for the patient's visit. Update this when you identify the primary concern."
      },
      subjective: {
        type: SchemaType.STRING,
        description: "Patient's description of symptoms, duration, medical history, medications, allergies, etc. Update when the patient shares relevant details."
      },
      objective: {
        type: SchemaType.STRING,
        description: "Observable findings or measurements. In a virtual visit, this may be limited to what the patient reports."
      },
      assessment: {
        type: SchemaType.STRING,
        description: "Your diagnostic impressions or potential diagnoses being considered. Update when your assessment evolves."
      },
      plan: {
        type: SchemaType.STRING,
        description: "Recommended treatments, medications, follow-ups, referrals, or lifestyle changes. Update as you develop the care plan."
      },
      icdCodes: {
...
## Chief Complaint
${chiefComplaint || "In progress..."}

## Medical Note

### Subjective
${subjective || "Gathering information..."}
...
*This document was generated by an AI medical assistant for informational purposes only. It does not constitute medical advice, diagnosis, or treatment. Please consult with a licensed healthcare professional for proper medical care.*
